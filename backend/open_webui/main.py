...
async def get_app_config(request: Request):
    ...
    config = await Config.get_many(
        ...
        'ui.internal_models',
        'ui.internal_models_message',
        'ui.external_models_message',
        'ui.welcome_message',
        # Custom - Ende        
        ...
        **(
            {
                ...
                # Custom - Start
                'always_pinned_models': (config.get('ui.always_pinned_models') or '').split(','),
                'internal_models': (config.get('ui.internal_models') or '').split(','),
                'message_internal_model': config.get('ui.internal_models_message'),
                'message_external_model': config.get('ui.external_models_message'),
                'welcome_message': config.get('ui.welcome_message'),
                # Custom - Ende                
